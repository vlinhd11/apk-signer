 ...
 *
 */
class DialogPreferences(owner: Window) extends JDialog(owner, Messages.getString(R.string.settings),
    ...
    var lblNewLabel = new JLabel(Messages.getString(
        R.string.pmsg_sensitive_data_encryption, Preferences.FILE.getName()))
    ...
    private def initTabs(): Unit = {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            override def run() = {
                ...
                var lastTabIndex = 0
                try {
                    lastTabIndex = Preferences.get(PKEY_LAST_TAB_INDEX).toInt
                } catch {
                    /*
                     * Ignore it.
                     */
